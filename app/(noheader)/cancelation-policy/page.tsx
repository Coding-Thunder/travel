...
export default function CancellationPolicyPage() {
  const term1 = [
    ...
    "Acceptance of alternative arrangements is required when suggested by universalticketss.com as your mediator.",
    "You may choose an alternative trip of similar standard if available. The alternative trip is treated as a new booking, and universalticketss.com will coordinate with the airline, hotel, or car rental provider for compensation or refunds related to your original booking.",
    ...
    "Each booking is governed by the refund and cancellation terms of both universalticketss.com and the respective provider. By booking, you agree to abide by both.",
  ];
  ...
  const term2 = [
    ...
    "universalticketss.com may request credit card authorization or ID verification. Failure to provide this may result in cancellation.",
    "In case of a system error or incorrect pricing, universalticketss.com reserves the right to correct the fare before confirmation. You are not obligated to continue with an erroneous booking.",
  ];
  const term3 = [
    "Displayed booking prices exclude surcharges, taxes, and service fees, which appear on the final confirmation screen.",
    "Charges on your payment method may appear under the provider’s or universalticketss.com’s name.",
    "Administrative or service processing fees of up to $30 USD per booking may apply.",
    "All service and processing fees charged by universalticketss.com are strictly non-refundable unless an error is proven to be on our part.",
    ...
    "In supplier-side cancellations (e.g., airline flight cancellations), refunds are issued per the supplier’s policy. universalticketss.com does not guarantee refund amounts or timelines.",
  ];
  ...
  const term4 = [
    ...
    "universalticketss.com assists in securing waivers from airlines, hotels, or car rental providers to facilitate refund requests.",
    ...
    "To request a cancellation or refund, email support@universalticketss.com with your Booking Reference Number, Full Name, Date of Travel/Booking, and Reason for Cancellation. Response time: 24–48 business hours.",
  ];
  ...
  const term6 = [
    "Customers agree not to dispute fees if universalticketss.com and providers have followed applicable policies.",
