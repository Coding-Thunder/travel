...
export default function CancellationPolicyPage() {
  const term1 = [
    ...
    "Acceptance of alternative arrangements is required when suggested by autrova.com as your mediator.",
    "You may choose an alternative trip of similar standard if available. The alternative trip is treated as a new booking, and autrova.com will coordinate with the airline, hotel, or car rental provider for compensation or refunds related to your original booking.",
    ...
    "Each booking is governed by the refund and cancellation terms of both autrova.com and the respective provider. By booking, you agree to abide by both.",
  ];
  ...
  const term2 = [
    ...
    "autrova.com may request credit card authorization or ID verification. Failure to provide this may result in cancellation.",
    "In case of a system error or incorrect pricing, autrova.com reserves the right to correct the fare before confirmation. You are not obligated to continue with an erroneous booking.",
  ];
  const term3 = [
    "Displayed booking prices exclude surcharges, taxes, and service fees, which appear on the final confirmation screen.",
    "Charges on your payment method may appear under the provider’s or autrova.com’s name.",
    "Administrative or service processing fees of up to $30 USD per booking may apply.",
    "All service and processing fees charged by autrova.com are strictly non-refundable unless an error is proven to be on our part.",
    ...
    "In supplier-side cancellations (e.g., airline flight cancellations), refunds are issued per the supplier’s policy. autrova.com does not guarantee refund amounts or timelines.",
  ];
  ...
  const term6 = [
    "Customers agree not to dispute fees if autrova.com and providers have followed applicable policies.",
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    ...
                    All reservations made through our platform are subject to the individual provider’s terms, refund rules, and cancellation policies. By booking through autrova.com, you acknowledge and accept these terms
                  </p>
                </div>
              </div>
            </CardContent>
