...
const TermsAndConditionsPage: React.FC = () => {
  ...
  const generalTerms = [
    "By using autrova.com, you agree to comply with these Terms and Conditions.",
    ...
    "autrova.com acts as a travel aggregator/mediator. We do not operate flights or car rentals directly.",
  ...
  const legalTerms = [
    "autrova.com is not liable for delays, cancellations, or other service disruptions caused by providers.",
    "We do not guarantee refunds or compensation beyond what the provider permits.",
    "By using our platform, you waive claims against autrova.com for any indirect, incidental, or consequential damages.",
